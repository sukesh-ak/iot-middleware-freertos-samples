...
extern const uint8_t mqtt_eclipse_org_pem_start[] asm("_binary_az_root_ca_pem_start");
extern const uint8_t mqtt_eclipse_org_pem_end[]   asm("_binary_az_root_ca_pem_end");
