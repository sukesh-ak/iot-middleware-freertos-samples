/********************************************************************************
 * Name:            esp_hw_common.c
 * Description:     @brief Common ESP32 HW init functions for Wi-Fi, NVS, & Config
 ...
 * Description  : @brief Callback to handle base level events from the ESP32 
