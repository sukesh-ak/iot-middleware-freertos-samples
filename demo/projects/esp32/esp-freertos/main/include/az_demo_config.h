...
#ifndef AZ_DEMO_CONFIG_H
#define AZ_DEMO_CONFIG_H
 ...
 *
 */
#define democonfigDEVICE_ID                 CONFIG_AZ_DEVICE_ID 

/**
 * @brief IoTHub module Id.
 *
 */
#define democonfigMODULE_ID                 CONFIG_AZ_MODULE_ID 
/**
 * @brief IoTHub hostname.
 *
 */
#define democonfigHOSTNAME                  CONFIG_AZ_MQTT_BROKER_HOSTNAME

/**
 * @brief Device symmetric key
 *
 */
#define democonfigDEVICE_SYMMETRIC_KEY      CONFIG_AZ_DEVICE_SYMMETRIC_KEY
